...
import { favouriteArticle } from '../../../api';
    ...
    return ( 
        <div className='container'>
          <div className='flex-1'>
                ...
                <div>
                 <button className={`favorite-button ${token && clicked && "favorite-button-clicked"} `} onClick={() => props.favouriteClick(article.slug, clicked)}>   
                    <div className='flex-1'>
           ...
           <Link to={`/article/${article.slug}`} style ={{textDecoration:'none'}}>
            <div>
                    <h4 className='none' style={{color:'black'}}> {article.title.slice(0,500)}</h4>
